...
6. **獨立匯出**：`analysis_results.xlsx` / `analysis_results.pdf`（總覽／收縮區間調整／裝置比對波形／刮腿毛波形／疲勞波形／疲勞可視／區間特徵）可單獨下載，不必翻 JSON 資料夾。
...
8. **波形章節**：裝置比對、刮腿毛（刮毛前／後）、疲勞皆有上下對照波形圖；時間軸以各檔錄音起點為 0 秒。
